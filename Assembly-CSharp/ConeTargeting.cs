...
public class ConeTargeting : global::ICheapState
{
	public ConeTargeting(global::UnitController ctrlr)
	{
	...
	void global::ICheapState.Enter(int iFrom)
	{
		...
		global::PandoraSingleton<global::MissionManager>.Instance.InitConeTarget(this.unitCtrlr.transform, (float)this.unitCtrlr.CurrentAction.Radius, (float)this.unitCtrlr.CurrentAction.RangeMax, out this.coneSrc, out this.coneDir);
		this.SetConePos();
		global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.SetActive(true);
	...
	void global::ICheapState.Update()
	{
		...
		else if (global::PandoraSingleton<global::PandoraInput>.Instance.GetKeyUp("action", 0))
		{
			...
			this.unitCtrlr.SendSkillTargets(this.unitCtrlr.CurrentAction.SkillId, global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.transform.position, global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.transform.forward);
		}
		else
		{
			...
			if (num != 0f || num2 != 0f)
			{
				...
				global::UnityEngine.Vector3 to = lhs * rhs * this.coneDir;
			...
			this.SetConePos();
			this.unitCtrlr.SetConeTargets(this.availableTargets, global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.transform, true);
		}
	}
	...
	{
		global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.transform.position = this.coneSrc;
		global::UnityEngine.Quaternion rotation = global::UnityEngine.Quaternion.LookRotation(this.coneDir);
		global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.transform.rotation = rotation;
		this.unitCtrlr.FaceTarget(global::PandoraSingleton<global::MissionManager>.Instance.coneTarget.transform.GetChild(0), false);
	...
	private global::UnityEngine.Vector3 coneSrc;

	private global::UnityEngine.Vector3 coneDir;
