...
public class test_camera_rotation : global::UnityEngine.MonoBehaviour
{
	private void Start()
	{
	...
	private void HandlePlayerInput()
	{
		...
		if (global::PandoraSingleton<global::PandoraInput>.Instance.GetAxis("mouse_wheel", 0) < -num || global::PandoraSingleton<global::PandoraInput>.Instance.GetAxis("mouse_wheel", 0) > num)
		{
			this.desiredDistance = global::UnityEngine.Mathf.Clamp(this.Distance - global::PandoraSingleton<global::PandoraInput>.Instance.GetAxis("mouse_wheel", 0) * this.MouseWheelSensitivity, this.DistanceMin, this.DistanceMax);
		}
	}
